...
_id,
name,description,image,rating,deliveryFee,estimatedDeliveryTime,"slug":slug.current,location,isActive,minimumOrder,totalReviews,"categoriesCount":count(categories),"foodItemsCount":count(foodItems)
}`;
        ...
        {restaurants.map((restaurant) => (
          <Link
            ...
            <Card className="overflow-hidden py-0 h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hoverEffect">
              ...
              <CardContent className="px-5 space-y-3 bg-amber-600">
